      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/[0.15] to-rose-500/[0.15] border border-white/[0.15] mb-8 md:mb-12 backdrop-blur-sm"
          >
            <Sparkles className="w-4 h-4 text-indigo-300" />
            <span className="text-sm md:text-base text-white/80 tracking-wide font-medium">Prompt Engineering Challenge</span>
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-5xl sm:text-7xl md:text-9xl font-bold mb-6 md:mb-8 tracking-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">Prompt</span>
              <br />
              <span
                className={cn(
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/50 mb-10 md:mb-12 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
              Master the art of AI communication. Compete with the brightest minds in crafting the perfect prompts. 
              Unleash your creativity and precision.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="mt-12 md:mt-16 flex flex-wrap items-center justify-center gap-6 md:gap-8 text-white/40 text-sm md:text-base"
          >
